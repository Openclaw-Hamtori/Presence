...
- **Live server canonical loop (link/verify/reauth/ready persistence) validated repeatedly on real device + Noctu**
  - Documented in `docs/archive/projects/presence-ship-closeout-2026-03-21.md`.
...
- **Live pending-proof API surface is now redeployed, route-mapped, and real-device revalidated on latest deploy**
  ...
  - Documented in `docs/archive/projects/presence-happy-path-pending-proof-redeploy-2026-03-22.md`, `docs/archive/projects/presence-happy-path-deploy-guardrails-2026-03-21.md`, and `docs/archive/projects/presence-pending-proof-respond-live-validation-2026-03-23.md`.
- **Live route-base/URL compatibility fixed** for `https://noctu.link/presence-demo/presence` through `ROUTE_BASE_PATH` stripping (`presence-happy-path/app/server.cjs`, commit `d37d550`; follow-up note `docs/archive/projects/presence-push-live-route-fix-2026-03-22.md`).
- **Push token upload path hardened** and route accepts persisted token formats only (`docs/archive/projects/presence-push-token-apns-format-fix-2026-03-22.md`, `docs/archive/projects/presence-ios-push-entitlement-debug-2026-03-22.md`).
...
- Prefer adding future state notes as short dated entries in `docs/archive/projects/` plus this closeout doc when direction changes.
